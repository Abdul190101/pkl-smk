...
$user = $user->row();
?>
<script src="public/backend/assets/css/fileinput.min.css"></script>
    ...
    <div class="row">
                  ...
                  <div class="col-lg-9">
                    <select class="form-control cari_jurusan" name="jurusan" required style="width:100%;">
                      ...
                      <?php foreach ($v_jurusan->result() as $baris){ ?>
                        <option value="<?php echo $baris->kd_jurusan; ?>" <?php if($baris->kd_jurusan == $user->kd_jurusan){echo "selected";} ?>><?php echo $baris->nama; ?></option>
                      <?php }; ?>
                    </select>
                  </div>
                </div>
      ...
      <?php }elseif ($level == 'Siswa') { ?>
                  ...
                  <div class="col-lg-9">
                    <select class="form-control cari_kelas" name="kelas" required style="width:100%;">
                      ...
                      <?php foreach ($v_kelas->result() as $baris){ ?>
                        <option value="<?php echo $baris->kd_kelas; ?>" <?php if($baris->kd_kelas == $user->kd_kelas){echo "selected";} ?>><?php echo $baris->nama; ?></option>
                      <?php }; ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="pemb" class="form-control" value="<?php echo $nama_pemb = $this->db->get_where('tbl_pembimbing', "kd_pembimbing='$user->kd_pembimbing'")->row()->nama_lengkap; ?>" placeholder="Nama Pembimbing"readonly>
                  </div>
                </div>
      <?php } ?>
            </fieldset>
...
<script src="public/backend/assets/js/fileinput.min.js"></script>
