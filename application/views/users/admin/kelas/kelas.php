    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h6 class="panel-title"><i class="icon-book"></i> Data Kelas <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
        ...
        <div class="panel-body">
          <div class="tabbable">
            <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
              <li class="<?php if($sub_menu3 == ''){echo 'active';} ?>"><a href="#tbl_kelas" data-toggle="tab" aria-expanded="true">Tambah Data Kelas</a></li>
            </ul>
                ...
                <table class="table datatable-basic" width="100%">
                  ...
                  <tbody>
                      ...
                      foreach ($v_kelas->result() as $baris) {
                        $jurusan = $this->db->get_where('tbl_jurusan',"kd_jurusan='$baris->kd_jurusan'")->row()->nama;
                      ?>
                        <tr>
                          <td><?php echo $no.'.'; ?></td>
                          ...
                          <td>
                            <a href="users/kelas/e_kelas/<?php echo $baris->kd_kelas; ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>
                            <a href="users/kelas/h_kelas/<?php echo $baris->kd_kelas; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-trash"></i></a>
                          </td>
                        </tr>
                      <?php
                      $no++;
