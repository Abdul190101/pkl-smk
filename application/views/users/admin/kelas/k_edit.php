        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-user"></i> Edit Kelas <?php if ($sub_menu3 == 'e_kelas') {echo "Kelas";}else{echo "Jurusan";} ?></legend>
                <?php
                    ...
                    <div class="col-lg-9">
                      <select class="form-control cari_jurusan" name="jurusan" required style="width:100%;">
                        ...
                        <?php foreach ($v_jurusan->result() as $baris){ ?>
                          <option value="<?php echo $baris->kd_jurusan; ?>" <?php if($user->kd_jurusan == $baris->kd_jurusan){echo "selected";} ?>><?php echo $baris->nama; ?></option>
                        <?php }; ?>
                      </select>
                    </div>
                  </div>
