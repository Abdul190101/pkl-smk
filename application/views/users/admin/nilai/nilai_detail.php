...
$cek_industri = $this->db->get_where('tbl_industri', "kd_industri='$user->kd_industri'")->row();
if ($cek_industri->kd_industri == '') {
    $nama_industri = '-';
    $bidang_kerja  = '-';
}else{
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                <hr>
                  ...
                  <h3 align="center">Penilaian PKL</h3>
                  <hr>
                  <table width="100%" border=0>
                      <tr>
