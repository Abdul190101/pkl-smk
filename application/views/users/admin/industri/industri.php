                  ...
                  <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="users/industri/d/<?php echo $baris->kd_industri; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                            <a href="users/industri/e/<?php echo $baris->kd_industri; ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>
                            <a href="users/industri/h/<?php echo $baris->kd_industri; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-trash"></i></a>
                          </td>
                        </tr>
                      <?php
                      $no++;
