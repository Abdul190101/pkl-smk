        ...
        <div class="row">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h6 class="panel-title"><i class="icon-file-text"></i> Data Sidang Siswa <b><?php echo ucwords($user->row()->nama_lengkap); ?></b> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                ...
                <div class="panel-body">
                    ...
                    ?>
                    <a href="users/sidang_siswa/t" class="btn btn-primary"><i class="icon-plus22"></i> Sidang</a>
                    ...
                    <table class="table datatable-basic" width="100%">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($v_sidang->result() as $baris) {
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="users/sidang_siswa/d/<?php echo $baris->kd_sidang; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                                            <a href="users/sidang_siswa/h/<?php echo $baris->kd_sidang; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin?')"><i class="icon-trash"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                    $no++;
