    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h6 class="panel-title"><i class="icon-envelop5"></i> Data Bimbingan Siswa <b><?php echo ucwords($user->row()->nama_lengkap); ?></b> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
        ...
        <div class="panel-body">
                ...
                ?>
                <a href="users/bimbingan_siswa/t" class="btn btn-primary"><i class="icon-plus22"></i> Bimbingan</a>
                  ...
                  <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <a href="users/bimbingan_siswa/d/<?php echo $baris->kd_bimbingan; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                              <a href="users/bimbingan_siswa/h/<?php echo $baris->kd_bimbingan; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin?')"><i class="icon-trash"></i></a>
                            </td>
                          </tr>
                      <?php
                      $no++;
