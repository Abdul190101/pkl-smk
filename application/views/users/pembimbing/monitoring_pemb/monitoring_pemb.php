        ...
        <div class="row">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h6 class="panel-title"><i class="icon-stats-bars2"></i> Data Log Book</b> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                        ...
                        <tbody>
                            ...
                            ?>
                                  <tr>
                                        ...
                                        <td>
                                            <a href="users/monitoring_pemb/d/<?php echo $baris->kd_monitoring; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                                        </td>
                                    </tr>  
                            <?php
                                    $no++;
