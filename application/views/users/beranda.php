      ...
      <div class="panel panel-flat bg-info">
        <div class="panel-heading">
          <h3 class="panel-title">
            <center>Selamat Datang, di PKL SMK AL-AMIIN Sangkanhurip <?php echo ucwords($nama); ?></center>
          </h3>
        </div>
      </div>
      <!-- /basic datatable -->
            ...
            <div class="col-lg-6">
              ...
              <div class="panel bg-teal-400">
                <div class="panel-body">
                  ...
                  <h3 class="no-margin">
                  <?php
                    echo number_format($this->db->query("SELECT * FROM tbl_pembimbing")->num_rows(), 0,",",".");
                  ?></h3>
                  Jumlah Debitur
                </div>
                <?php if ($level == 'Admin'): ?>
